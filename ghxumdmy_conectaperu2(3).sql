...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-04-2021 a las 21:18:14
...
--
-- Base de datos: `ghxumdmy_conectaperu2`
--
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `businessBy_Category` (`idCat` INT)  BEGIN
SELECT RucEmpresa,NomEmpresa,Logo FROM empresas WHERE IdCategoria = idCat;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `featured_Products` ()  BEGIN
SELECT DISTINCT e.RucEmpresa,pr.NomProducto,pr.Precio,pr.ImagenUrl,c.nombre as Categoria,p.Vendido FROM pedidos as p 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `listAll_Category` ()  BEGIN
SELECT * FROM categorias;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `OrderBestSeller` (IN `rucBest` INT)  BEGIN
SELECT pedidos.IdProducto,p.Imagen,p.NomProducto,p.Descripcion,p.Precio, SUM(pedidos.Vendido) AS MAS_Vendidos FROM pedidos 
INNER JOIN productos as p 
ON pedidos.IdProducto=p.IdProducto 
WHERE p.RucEmpresa = rucBest AND p.Estado = 1 AND pedidos.Vendido =1 
GROUP BY pedidos.IdProducto
LIMIT 5;

END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `productsBy_Ruc` (`ruc` INT)  BEGIN
SELECT * FROM productos WHERE RucEmpresa = ruc AND Estado = true;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `resetPass_withToken` (`mytoken` VARCHAR(30), `pass` VARCHAR(60), `idRuc` INT)  BEGIN
UPDATE empresas SET Contrasena = pass WHERE token = mytoken;
UPDATE empresas SET token = null WHERE RucEmpresa = idRuc;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `searchBy_name` (IN `name` VARCHAR(20))  BEGIN
SELECT * FROM productos WHERE NomProducto LIKE CONCAT('%',name,'%');
END$$
...
CREATE TABLE `empresas` (
  ...
  `EmailEmp` varchar(200) CHARACTER SET utf8mb4 DEFAULT NULL,
  ...
  `Telefono` varchar(9) NOT NULL,
  `Whatsapp` varchar(11) CHARACTER SET utf8mb4 DEFAULT NULL,
  `Facebook` varchar(200) CHARACTER SET utf8mb4 DEFAULT NULL,
  `Instangram` varchar(200) CHARACTER SET utf8mb4 DEFAULT NULL,
...
INSERT INTO `empresas` (`RucEmpresa`, `NumRucEmp`, `NomEmpresa`, `Contrasena`, `IdCategoria`, `Descripcion`, `Logo`, `NomTitular`, `EmailEmp`, `Direccion`, `Distrito`, `EmailPers`, `Telefono`, `Whatsapp`, `Facebook`, `Instangram`, `logoUrl`, `Estado`, `token`) VALUES
(1, '0', 'aaa', '$2y$10$X/lWtgsH4V9O1VXwtt0aauw1W0J6TxUTCJqO2GKzaAlWwdUdyYB4e', 1, 'jhh', 'mm.jpg', 'jhff', 'ggh', 'fghb', NULL, 'utestroger@gmail.com', '766', '6667', '', '', '', 1, NULL),
(2, '67476890400', 'Salazar Tecnology Inc.', '$2y$10$DO3C7O6y5rZ1NaF1o1JnTOwZk40IW0PYGL6kpwFMBlIMzF0fX9yYC', 2, 'here tecnology 2021', 'female1_logo_161894668520.webp', 'Roger', 'corp2@corp.com', 'av. Ramoz Castill', '090101', 'admin@gmail.com', '998765468', '997654567', 'https://web.facebook.com/', 'https://web.facebook.com/', './vistas/panel_usuario/logoemp/female1_logo_161894668520.webp', 1, NULL),
(3, '1234', 'asolin', 'aso', 3, '', '', 'juan nn', '', 'av limatrom', NULL, 'aso@gmail.com', '986543456', '', '', '', '', 1, NULL),
(22, '', 'jaja', '666363', 4, NULL, NULL, '', NULL, '', NULL, 'catromeco@gmail.com', '', NULL, NULL, NULL, NULL, 1, NULL),
(23, '', 'jaja', '$2y$10$G31X6tYjhANHQfJxNpyi0OkrAZkgUy0/YpC0cOu6T9/9.coTXfX1C', 5, NULL, NULL, '', NULL, '', NULL, 'catromeco@gmail.com', '', NULL, NULL, NULL, NULL, 1, NULL),
(24, '', 'ahhhhh', '$2y$10$mUyD1P8jlDt3Xi2zb1rEhOADDQ1kF5W0RYPYNx9zLIfeYeam.6JLK', 6, NULL, NULL, '', NULL, '', NULL, 'chulo@gmail.com', '', NULL, NULL, NULL, NULL, 1, NULL),
(25, '', 'mama', '$2y$10$dgZIujvdn79HqyNAa50fJeBfWDre.LY4.t7aX9gtVbW.fm61dxil6', 7, NULL, NULL, '', NULL, '', NULL, 'mammam@gmail.com', '', NULL, NULL, NULL, NULL, 1, NULL),
(26, '76876545678', 'manogolif', '$2y$10$yhfUsV7D.1coDFbMfJd8R.Q2NbT8utCAojhhMGkzkWpOGhnkQuqM.', 8, NULL, NULL, '', NULL, '', NULL, '1@gmail.com', '', NULL, NULL, NULL, NULL, 1, NULL),
(27, '56456789865', 'dos', '$2y$10$fsCKalEcBEa5VSQUk92.pOkGNI3hzwN0bktewrjxANaFr0oAZBUfW', 9, 'mmaaa', 'female1_logo_161850354415.webp', 'eduardina', 'doscorp@gmail.com', 'av junito peres', '090101', '2@gmail.com', '999987879', '', '', '', './vistas/panel_usuario/logoemp/female1_logo_161850354415.webp', 1, NULL),
(28, '636464', 'admin', '$2y$10$ucZ2Rjj5T0WU9lP72L0ZcOI.6rsnUgZNw9QmDIxLgUacc.3Ii6bb6', 10, NULL, NULL, 'aggag', NULL, 'aggaga', NULL, 'jjjjjj@gmail', '998765456', NULL, NULL, NULL, NULL, 1, NULL),
(29, '45434567890', 'lazip', '$2y$10$T99PM1Y8vgGI/sP/t6MjC.Y.DiD42PBXIs40LmvH4d9N2zUMXvnie', 11, 'mmmmm', 'famele3_logo_161852426924.webp', 'lapiz', 'lapiz@corp.com', 'av lapiz', '090101', 'lapiz@gmail.com', '999876545', '', '', '', './vistas/panel_usuario/logoemp/famele3_logo_161852426924.webp', 1, NULL),
(30, '87655433456', 'mago', '$2y$10$Lnjb4kBwjlHag1.Jg7silOC4BTq7rgKsqPiWm1hORkGkb2d/Yl1BG', 6, NULL, NULL, 'magincio', NULL, 'av magito', NULL, 'mago@gmail.com', '888888888', NULL, NULL, NULL, NULL, 1, NULL),
(31, '56543322223', 'saco liveros', '$2y$10$F9myDQ5qoI7ErRcA9OAV6Oy4bV3cE8tvGrbSWYWaIschmKLpZwbWi', 6, NULL, NULL, 'sacolinj', NULL, 'av sacolin', NULL, 'sacoliveros@gmail.com', '777777655', NULL, NULL, NULL, NULL, 1, NULL),
(32, '', 'sanonigo sa c', '$2y$10$kFdtKLtq6ADcHfkRNMJCauQCkbc/qg34rQJeOWRve3oKSzrZkjt2C', 8, NULL, NULL, 'saco mongi', NULL, 'av sacoliberongos', NULL, 'salazar1@gmail.com', '999965436', NULL, NULL, NULL, NULL, 1, NULL),
(33, '', 'eduardito ginzales', '$2y$10$iYZ.nzs2XdDhfmyd/lrqEuiXkYw9IVENYMQUkx.1kl3/SMPuAJpbW', 8, 'mmm', 'famele3_logo_161860403168.webp', 'eduardigolaco', 'mm@coprcom', 'av miraflorino', '020101', 'mmmmmm@gmail.com', '999876545', '', '', '', './vistas/panel_usuario/logoemp/famele3_logo_161860403168.webp', 1, NULL),
(34, '', 'mmmknuhuh', '$2y$10$E/e63GdO55ocfV54RaT6BOaAtEdZbkaru2UetyegaGCPwlEGluQre', 8, NULL, NULL, 'ubuub', NULL, 'juuuh', NULL, 'megamaluca@gmail.com', '999999765', NULL, NULL, NULL, NULL, 1, NULL);
...
INSERT INTO `pedidos` (`IdPedido`, `IdCliente`, `Fecha`, `IdProducto`, `nombre`, `apellido`, `Cantidad`, `telefono`, `direccion`, `Comentarios`, `Vendido`, `Estado`) VALUES
(28, NULL, '2021-04-12 17:34:12', 59, 'roger', 'salazar', 23, 998787986, 'av. martilin', 'please i need fast por my bestiment jaa', 1, 1),
(29, NULL, '2021-04-12 19:05:30', 59, 'caminacio', 'mm', 1, 888876543, 'dv', 'mm', 1, 1),
(30, NULL, '2021-04-09 19:09:39', 60, 'ubgygyf', 'jbb', 100000, 999876543, 'ggd', NULL, 1, 1),
(31, NULL, '2021-04-15 18:17:41', 62, 'eduardito', 'melocoton', 32, 998765467, 'av megatron', 'hahhaha', 1, 1),
(32, NULL, '2021-04-16 00:07:12', 63, 'pen', 'tupen', 20, 998765467, 'av pentoo', 'manotoncion', 1, 1),
(33, NULL, '2021-04-16 14:07:51', 65, 'testfive', 'manas', 23, 887687987, 'av san jorge', 'nanannanna', 1, 1),
(34, NULL, '2021-04-16 19:33:32', 65, 'eduardito', 'durancito', 34, 998767687, 'av eduarcitolob', 'gagga', 0, 1),
(35, NULL, '2021-04-20 20:01:10', 61, 'mm', 'mmhg', 56, 998765444, 'vyvy', 'knknkink', 0, 1),
(36, NULL, '2021-04-20 20:06:21', 61, 'suhuuh', 'iiib', 23, 899876545, 'av hahah', 'kakka', 1, 1),
(37, NULL, '2021-04-20 20:40:52', 61, 'eduardo', 'mongo', 56, 990989898, 'ggh', 'mmm', 1, 1),
(38, NULL, '2021-04-21 01:10:15', 61, 'filter', 'filter', 30, 0, 'av filter', 'mmm', 0, 1),
(39, NULL, '2021-04-21 01:10:15', 61, 'filter', 'filter', 30, 0, 'av filter', 'mmm', 0, 1),
(40, NULL, '2021-04-21 01:10:52', 59, 'titr', 'titi', 60, 998111111, 'av titit', 'mm', 0, 1),
(41, NULL, '2021-04-21 01:10:52', 59, 'titr', 'titi', 60, 998111111, 'av titit', 'mm', 0, 1),
(42, NULL, '2021-04-21 01:12:31', 65, 'gaa', 'gaa', 50, 111111111, 'av saga', 'lolalla', 0, 1),
(43, NULL, '2021-04-21 01:12:31', 65, 'gaa', 'gaa', 50, 111111111, 'av saga', 'lolalla', 0, 1),
(44, NULL, '2021-04-21 01:14:47', 59, 'melagatoga', 'sagatoja', 90, 10101010, 'av mm', 'mm', 0, 1),
(45, NULL, '2021-04-21 21:12:15', 59, 'mm', 'loca', 30, 121111111, 'av limamongis', 'mmm', 0, 1);
...
INSERT INTO `productos` (`IdProducto`, `RucEmpresa`, `NomProducto`, `Descripcion`, `Precio`, `Stock`, `Medida`, `Imagen`, `ImagenUrl`, `Imagen1`, `Imagen2`, `Estado`) VALUES
(59, 2, 'prueba', 'this is demo', '40.00', 50, 'Unidad(es)', 'imagen1_producto_161841333782.webp', './vistas/panel_usuario/imgproducts/imagen1_producto_161841333782.webp', 'imagen2_producto_161841333732.webp', 'imagen2_producto_161841333851.webp', 1),
(60, 1, 'melamela', 'jjhg', '56.00', 45, 'mm', 'mm.jpg', 'jjjh.com', 'mm', 'mm', 1),
(61, 2, 'mmmmmmm', 'mmm', '66.00', 67, 'Unidad(es)', 'c1_producto_161853462343.webp', './vistas/panel_usuario/imgproducts/c1_producto_161853462343.webp', 'c2_producto_161853462387.webp', 'c2_producto_161853462398.webp', 1),
(62, 27, 'nuevito', 'nuevito com', '56.00', 23, 'Unidad(es)', 'c1_producto_161850341375.webp', './vistas/panel_usuario/imgproducts/c1_producto_161850341375.webp', 'imagen1_producto_161850341332.webp', 'imagen1_producto_161850341356.webp', 1),
(63, 29, 'lapiz', 'lapizzz', '56.00', 23, 'Unidad(es)', 'female1_producto_161852433047.webp', './vistas/panel_usuario/imgproducts/female1_producto_161852433047.webp', 'imagen1_producto_16185243308.webp', 'imagen1_producto_161852433052.webp', 1),
(64, 29, 'pen', 'tha pen is beautiful', '89.00', 89, 'Unidad(es)', 'imagen3_producto_161852437443.webp', './vistas/panel_usuario/imgproducts/imagen3_producto_161852437443.webp', 'nhl-hilton-logo-02_producto_16185243745.webp', 'nhl-hilton-logo-02_producto_161852437532.webp', 0),
(65, 2, 'test6', 'hahshs', '54.00', 23, 'Unidad(es)', 'c2_producto_16185747721.webp', './vistas/panel_usuario/imgproducts/c2_producto_16185747721.webp', 'c3_producto_161857477295.webp', 'c3_producto_16185747728.webp', 1),
(66, 33, 'nolose', 'nosolose rick', '23.00', 34, 'Unidad(es)', 'c2_producto_16186040027.webp', './vistas/panel_usuario/imgproducts/c2_producto_16186040027.webp', 'c3_producto_161860400258.webp', 'c3_producto_161860400242.webp', 1);
...
--
ALTER TABLE `empresas`
  MODIFY `RucEmpresa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `productos`
  ADD CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`RucEmpresa`) REFERENCES `empresas` (`RucEmpresa`);
