...
<body>
	<div class="page-container">
		...
		<main class="main__contacto col-md-6">
			<form action="../controladores/enviarcorreo.php" class="form" method="post">
				...
				<div class="form__section form__content">
					<input type="text" class="formSec__item margin col-md-12" placeholder="DNI" name="dni" id="dni" pattern="[0-9]{8}" title="Debe poner 8 números" required>
					<input class="formSec__item col-md-12" type="text" placeholder="Provincia/Distrito" name="provincia" id="provincia" required>
					<input type="email" class="formSec__item margin col-md-12 " name="email" id="email" placeholder="Email" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" title="e.g. aso@gmail.com" required>
					<input class="formSec__item col-md-12" type="text" name="telefono" id="telefono" placeholder="Teléfono"   pattern="[0-9]{9,12}" title="debe conter numeros" required>
				</div>
